...
typedef enum {
    ...
    TOK_FOREVER, TOK_IF, TOK_ELSE, TOK_READ, TOK_ANALOG, TOK_PULSE, TOK_SERVO, TOK_PRINT, TOK_PRINTLN, TOK_DEF, TOK_REPEAT,
    TOK_TONE, TOK_NOTONE, TOK_FREQ, TOK_RETURN,
    TOK_WHILE, TOK_BREAK, TOK_CONTINUE,
    ...
    TOK_ASIN, TOK_ACOS, TOK_ATAN, TOK_ATAN2,
    TOK_ASSIGN, TOK_EQ, TOK_NEQ, TOK_LT, TOK_GT, TOK_LTE, TOK_GTE, TOK_PLUS, TOK_MINUS, TOK_STAR, TOK_SLASH, TOK_MOD, TOK_AND, TOK_OR, TOK_NOT,
